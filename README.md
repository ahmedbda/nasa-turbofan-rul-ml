...
Paper: [Damage Propagation Modeling for Aircraft Engine Run-to-Failure Simulation](https://c3.ndc.nasa.gov/dashlink/static/media/publication/2008_IEEEPHM_CMAPPSDamagePropagation.pdf) by NASA 2008